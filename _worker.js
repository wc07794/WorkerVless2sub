...
// 设置优选地址api接口
let addressesapi = [
	'https://bbedefb7.cf-workers-text2kv-bwf.pages.dev/ip.txt?token=0106', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	//'https://bbedefb7.cf-workers-text2kv-bwf.pages.dev/cesu.csv?token=0106', //iptest测速结果文件。
];
